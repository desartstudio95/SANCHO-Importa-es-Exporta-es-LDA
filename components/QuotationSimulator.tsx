...
import { Calculator, Package, Send, RefreshCw, AlertCircle, Ship, Plane, ChevronDown, MessageCircle } from 'lucide-react';
    ...
    <div className="pt-24 pb-16 md:pt-28 md:pb-24 min-h-screen bg-slate-50 transition-colors duration-300">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 md:mb-12 opacity-0 translate-y-8 animate-on-scroll">
          ...
          <h1 className="text-xl md:text-3xl font-extrabold text-sancho-primary mb-3 md:mb-4">
            Simulador de Importação
          </h1>
          <p className="text-slate-600 text-xs md:text-base max-w-2xl mx-auto">
        ...
        <div className="opacity-0 translate-y-8 animate-on-scroll bg-white rounded-2xl md:rounded-3xl shadow-2xl overflow-hidden border border-slate-100 transition-all duration-500">
          ...
          <div className="p-6 md:p-12 border-b border-slate-100 bg-slate-50/50">
            <div className="grid grid-cols-1 gap-6 md:gap-8">
              ...
              {/* Equipment Selector */}
              <div>
                <label className="block text-sm md:text-base font-bold text-sancho-primary mb-2 md:mb-3 flex items-center gap-2">
                ...
                <div className="relative">
                  <select 
                    ...
                    className="w-full pl-4 pr-10 py-4 rounded-xl border border-slate-300 focus:border-sancho-accent focus:ring-4 focus:ring-sancho-accent/10 outline-none transition-all appearance-none bg-white text-slate-700 font-medium text-sm md:text-base shadow-sm hover:border-sancho-accent/50 cursor-pointer"
                  >
              ...
              {/* Freight Selector */}
              <div>
                <label className="block text-sm md:text-base font-bold text-sancho-primary mb-2 md:mb-3">Método de Envio</label>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <span className="font-bold text-sm md:text-base">Marítimo (Navio)</span>
                  ...
                  >
                    ...
                    <span className="font-bold text-sm md:text-base">Aéreo (Avião)</span>
              ...
              <div ref={resultsRef} className="p-6 md:p-12 bg-white">
                <div className="bg-sancho-primary rounded-2xl p-6 md:p-8 text-white mb-8 shadow-xl relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <h3 className="text-slate-300 text-xs uppercase tracking-widest font-bold mb-2">Custo Total Estimado (DDP)</h3>
                    <div className="flex items-baseline gap-2 mb-2">
                       <span className="text-3xl md:text-4xl font-extrabold text-sancho-yellow tracking-tight">
                         {result.grandTotal.toLocaleString('pt-MZ', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                       </span>
                       <span className="text-lg font-bold text-sancho-yellow">MZN</span>
                    </div>
                    <p className="text-blue-200 text-xs md:text-sm border-t border-white/10 pt-4 mt-2">
                ...
                <div className="space-y-6">
                  {/* Breakdown Header */}
                  <h3 className="text-lg font-bold text-sancho-primary border-b border-slate-100 pb-2">
