    ...
    <div className="bg-slate-50 min-h-screen">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="opacity-0 translate-y-8 animate-on-scroll">
            <span className="text-sancho-accent font-bold uppercase tracking-widest text-xs mb-2 block">Passo a Passo</span>
            <h2 className="text-2xl md:text-4xl font-extrabold text-sancho-primary mb-4">Como Trabalhamos</h2>
      ...
      <section className="bg-sancho-primary py-24 text-white relative overflow-hidden opacity-0 translate-y-8 animate-on-scroll">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          <h2 className="text-2xl md:text-4xl font-extrabold mb-6 drop-shadow-lg">
