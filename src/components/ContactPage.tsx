...
const ContactPage: React.FC = () => {
  ...
  return (
    <div className="bg-slate-50 min-h-screen">
      <SEO 
        title="Contactos" 
        description="Entre em contacto com a SANCHO Importações & Exportações LDA. Estamos localizados em Maputo e prontos para atender suas necessidades de máquinas e logística."
        canonical="/contactos"
      />
      {/* 1. HERO SECTION */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="opacity-0 translate-y-8 animate-on-scroll bg-slate-50 p-8 rounded-3xl border border-slate-100 shadow-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button 
                  type="submit" 
                  className="w-full bg-sancho-primary hover:bg-sancho-yellow hover:text-sancho-primary text-white font-bold py-4 rounded-xl shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2 text-lg transform hover:-translate-y-1 group"
                  title="Enviar mensagem de contacto"
