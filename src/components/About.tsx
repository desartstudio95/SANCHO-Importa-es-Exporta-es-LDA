...
const About: React.FC = () => {
  ...
  return (
    <div className="bg-slate-50">
      <SEO 
        title="Sobre Nós" 
        description="Conheça a história, missão e valores da SANCHO Importações & Exportações LDA. Excelência em máquinas pesadas e logística em Moçambique."
        canonical="/sobre"
      />
      {/* 1. HERO SECTION */}
      <section className="relative h-[60vh] min-h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 animate-fade-in-up">
          ...
          <p className="text-base md:text-lg text-blue-100 font-medium tracking-wide max-w-2xl mx-auto">
            ...
            <div className="lg:w-1/2 opacity-0 translate-y-8 animate-on-scroll">
              ...
              <div className="mt-10 flex gap-4">
                 <a 
                   ...
                   title="Falar com um consultor no WhatsApp"
